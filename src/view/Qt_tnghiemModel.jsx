...
export default class Qt_tnghiemModal extends React.Component {
    ...
    show(item, cbcnv) {      
        ...
        const { _id, MS_NV, STT, BAI_TN, NAM} = item ?
            item : { _id: null, MS_NV: '', STT: '', BAI_TN: '', NAM: ''};
        $('#MS_NV').val(MS_NV);
        $('#STT').val(STT);
        $('#BAI_TN').val(BAI_TN);
        $('#NAM').val(NAM);
                    ...
                    <div className='modal-content'>
                        ...
                        <div className='modal-body'>                                                       
                            ...
                            <div className='form-group'>
                                ...
                                <input className='form-control' id='BAI_TN' type='text' placeholder='' onChange={this.handleInput('text', 'BAI_TN')} value={this.state.text.BAI_TN}/>
                            </div> 
                            <div className='form-group'>
