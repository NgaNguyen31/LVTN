...
export default class Pctn_nghe_2018Modal extends React.Component {
    ...
    save(e) {
        e.preventDefault();
        const changes = {
            SHCC: this.state.text.SHCC,
            HO: this.state.text.HO,
            TEN: this.state.text.TEN,
            NGAY_SINH: this.state.text.NGAY_SINH,
            MS_CDNN: this.state.text.MS_CDNN,
            NGAY_PCTN_OLD: this.state.text.NGAY_PCTN_OLD,
            PT_PCTN_OLD: this.state.text.PT_PCTN_OLD,
            NGAY_PCTN_NEW: this.state.text.NGAY_PCTN_NEW,
            PT_PCTN_NEW: this.state.text.PT_PCTN_NEW,
                    ...
                    <div className='modal-content'>
                        ...
                        <div className='modal-body'>
                            <div className='form-group'>
                                ...
                                <input className='form-control' id='SHCC' type='number' placeholder='SHCC' onChange={this.handleInput('text', 'SHCC')} value={this.state.text.SHCC}/>
                            </div>
                            <div className='form-group'>
                            ...
                            <div className='form-group'>
                                ...
                                <input className='form-control' id='ngaysinh' type='date' placeholder='Ngày sinh' onChange={this.handleInput('text', 'NGAY_SINH')} value={this.state.text.NGAY_SINH}/>
                            </div>
                            <div className='form-group'>
                            ...
                            <div className='form-group'>
                                ...
                                <input className='form-control' id='NGAY_PCTN_OLD' type='date' placeholder='Ngày PCTN cũ' onChange={this.handleInput('text', 'NGAY_PCTN_OLD')} value={this.state.text.NGAY_PCTN_OLD}/>
                            </div>
                            <div className='form-group'>
                                <label htmlFor='tenloai'>PT PCTN cũ</label>
                                <input className='form-control' id='PT_PCTN_OLD' type='number' placeholder='PT PCTN cũ' onChange={this.handleInput('text', 'PT_PCTN_OLD')} value={this.state.text.PT_PCTN_OLD}/>
                            </div>
                            <div className='form-group'>
                                <label htmlFor='tenloai'>Ngày PCTN mới</label>
                                <input className='form-control' id='NGAY_PCTN_NEW' type='date' placeholder='Ngày PCTN mới' onChange={this.handleInput('text', 'NGAY_PCTN_NEW')} value={this.state.text.NGAY_PCTN_NEW}/>
                            </div>
                            <div className='form-group'>
                                <label htmlFor='tenloai'>PT PCTN mới</label>
                                <input className='form-control' id='PT_PCTN_NEW' type='number' placeholder='PT PCTN mới' onChange={this.handleInput('text', 'PT_PCTN_NEW')} value={this.state.text.PT_PCTN_NEW}/>
                            </div>
                            <div className='form-group'>
