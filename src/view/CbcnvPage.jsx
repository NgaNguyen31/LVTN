                ...
                <table className='table table-hover table-bordered' ref={this.table}>
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: '10%', textAlign: 'center' }}>Loại</th>
                            <th style={{ width: '5%', textAlign: 'center' }}>SHCC</th>
                            ...
                            <th style={{ width: '10%', textAlign: 'center' }}>Chức danh</th>
                            ...
                            <th style={{ width: '5%', textAlign: 'center' }}>Hệ số LG</th>
                            ...
                            <th style={{ width: '10%', textAlign: 'center' }}>MS BM</th>
                            ...
                            <th style={{ width: '10%', textAlign: 'center' }}>Điện thoại</th>
